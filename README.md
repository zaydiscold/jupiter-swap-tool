...
2. Clone this repository and run `npm install` inside `jupiter-swap-tool/` to pull JavaScript dependencies.
...
For more operational context (including launcher hotkeys) see the in-repo patch notes and the detailed README inside `jupiter-swap-tool/`.
